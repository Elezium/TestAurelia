...
(function(process) {
  !function(undefined) {
    ...
    (function(modules) {
      ...
      var $def = __webpack_require__(62);
      $def($def.P, 'String', {codePointAt: __webpack_require__(74)(false)});
    }, function(module, exports, __webpack_require__) {
      'use strict';
      var $ = __webpack_require__(59),
          cof = __webpack_require__(61),
          $def = __webpack_require__(62),
          toLength = $.toLength;
      $def($def.P + $def.F * !__webpack_require__(77)(function() {
        'q'.endsWith(/./);
      ...
      $def($def.S + $def.F * !__webpack_require__(80)(function(iter) {
        Array.from(iter);
      ...
      'use strict';
      var strong = __webpack_require__(86);
      __webpack_require__(87)('Set', {add: function add(value) {
      ...
      __webpack_require__(87)('WeakSet', {add: function add(value) {
      ...
      var $def = __webpack_require__(62);
      $def($def.P, 'Array', {includes: __webpack_require__(67)(true)});
      __webpack_require__(82)('includes');
    }, function(module, exports, __webpack_require__) {
      var $def = __webpack_require__(62);
      $def($def.P, 'String', {at: __webpack_require__(74)(true)});
    }, function(module, exports, __webpack_require__) {
      var $def = __webpack_require__(62);
      ...
      $def($def.P + $def.F, 'Function', {part: __webpack_require__(91)});
    }, function(module, exports, __webpack_require__) {
      var $ = __webpack_require__(59),
          $def = __webpack_require__(62),
          ownKeys = __webpack_require__(89);
      ...
      function setStatics(keys, length) {
        $.each.call(keys.split(','), function(key) {
          if (length == undefined && key in $Array)
            ...
            statics[key] = __webpack_require__(78)(Function.call, [][key], length);
        });
      }
      ...
      module.exports = function(NAME, methods, common, IS_MAP, IS_WEAK) {
        ...
        if (!$.isFunction(C) || !(IS_WEAK || !BUGGY && proto.forEach && proto.entries)) {
          ...
          var inst = new C,
              ...
              buggyZero;
          if (!__webpack_require__(80)(function(iter) {
            new C(iter);
          })) {
            C = function() {
